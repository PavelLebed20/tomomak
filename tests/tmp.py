...
axes = [Axis1d(name="x", units="cm", size=30), Axis1d(name="Y", units="cm", size=40), Axis1d(name="Y", units="cm", size=130)]
...
det = detectors2d.fan_detector_array(mesh, (5,5), 8, 5, 10, 1, incline=0 )
...
mod = Model(mesh=mesh, detector_geometry=det )
mod.save("mod.txt")
